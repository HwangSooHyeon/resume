...
class $AssetLottieGen {
  ...
  /// File path: asset/lottie/config_lottie.json
  LottieGenImage get configLottie =>
      const LottieGenImage('asset/lottie/config_lottie.json');

  /// List of all assets
  List<LottieGenImage> get values => [configLottie];
}
